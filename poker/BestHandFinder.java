...
public class BestHandFinder {
	 ...
	 * determine the rank of the hand and will return the corresonding integer
	 ...
	 */
		public static int evaluateFiveCardHand(Card [] cards) {
			if (PokerHandEvaluator.hasStraightFlush(cards))
				return 11;
				...
				return 7;
			else if (PokerHandEvaluator.hasEvenStraight(cards))
				return 6;
			else if (PokerHandEvaluator.hasOddStraight(cards))
				return 5;
